...
export function ShoppingBagIcon({ size = 20, color = "currentColor", className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MenuIcon({ size = 22, color = "currentColor", className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArrowRightIcon({ size = 18, color = "currentColor", className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TruckIcon({ size = 22, color = "currentColor", className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShieldCheckIcon({ size = 22, color = "currentColor", className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
